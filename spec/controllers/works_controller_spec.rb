...
describe WorksController do
  ...
  let(:valid_attributes) { { "name" => "MyString", "artist_id" => "1", "year_completed" => "1900", "materials" => "oil paints", "image_url" => "http://www.tate.org.uk/art/images/work/T/T05/T05010_10.jpg" } }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested work" do
        ...
        Work.any_instance.should_receive(:update).with({ "name" => "MyString" })
